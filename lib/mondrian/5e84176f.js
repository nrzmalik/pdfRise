...
`;let Se=class extends we{constructor(){super(...arguments),this.selected=!1,this.bindEvents=()=>{this.on("mouseenter",(()=>{this.dispatch("hover",{value:this.value,hovered:!0})})),this.on("mouseleave",(()=>{this.dispatch("hover",{value:this.value,hovered:!1})}))}}render(){return me.qy`
      <slot name="icon"></slot>
      <span class="content">
        <slot></slot>
      </span>
    `}};Se.formAssociated=!0,Se.styles=Ce,(0,ue.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],Se.prototype,"name",void 0),(0,ue.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],Se.prototype,"value",void 0),(0,ue.Cg)([(0,Ae.MZ)({type:Boolean,reflect:!0})],Se.prototype,"selected",void 0),(0,ue.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],Se.prototype,"for",void 0),Se=(0,ue.Cg)([(0,Ae.EM)("mon-menu-item")],Se);const ze=me.AH`
  * {
    box-sizing: border-box;
  }
...
`;let Ee=class extends we{constructor(){super(...arguments),this.open=!1,this.value=null,this.onSubmit=t=>{this.value=t.detail.value,this.open=!1},this.onClickOutside=t=>{this.hasWithin(t.detail.$target)||(this.open=!1)},this.onClickTrigger=()=>{this.open=!this.open},this.onKeyUp=t=>{"ArrowDown"===t.key&&(t.preventDefault(),this.open=!0)},this.onSlotChange=()=>{this.value||(this.value=this.$selected?.value??null)},this.renderLabel=()=>{if(this.value)return this.$$$(`mon-menu-item[value="${this.value}"]`)[0]?.innerText}}get $selected(){return this.$$$("mon-menu-item[selected]")[0]}renderTrigger(){const t=this.renderLabel()??me.qy`<slot name="placeholder">Choose an item…</slot>`;return me.qy`
    ...
    `:me.qy`
        ...
        ></slot>
      `}render(){return me.qy` ${this.renderTrigger()} ${this.renderMenu()} `}};var Ie;Ee.styles=ze,(0,ue.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],Ee.prototype,"name",void 0),(0,ue.Cg)([(0,Ae.MZ)({type:Boolean,reflect:!0})],Ee.prototype,"open",void 0),(0,ue.Cg)([(0,Ae.wk)()],Ee.prototype,"value",void 0),Ee=(0,ue.Cg)([(0,Ae.EM)("mon-dropdown")],Ee);const Me=me.AH`
  * {
    box-sizing: border-box;
  }
...
`;let Re=class extends we{constructor(){super(...arguments),this.bordered=!0,this.floating=!1,this.autofocusit=!1,this.value=null,this.pressing=!1,this.bindEvents=()=>{this.on("change",this.onChange),this.on("click",this.onClick),this.on("keydown",this.onKeydown),this.on("keyup",this.onKeyup),this.on("mouseover",this.onMouseover),this.collectOff(he("mousedown",window,(t=>{t.target instanceof HTMLElement&&!this.hasWithin(t.target)&&this.dispatch("clickoutside",{$target:t.target})})))},this.submit=()=>{this.dispatch("mon-menu:submit",{name:this.name,value:this.value})},this.choose=t=>{const e=t.closest("label")?.querySelector("input");e&&(e.checked=!0,e.focus(),e.dispatchEvent(new Event("change",{bubbles:!0})))},this.focusFirstApplicableItem=()=>{const t=this.$selected??this.$$$("mon-menu-item")[0];t&&this.choose(t)},this.onMouseover=t=>{t.target instanceof Se&&this.choose(t.target)},this.onChange=t=>{this.value=t.target.value??null,this.$slotted.forEach((t=>{const e=t.querySelector("mon-menu-item");e&&e.toggleAttribute("selected",e.value===this.value)}))},this.onClick=t=>{!this.pressing&&t.target instanceof HTMLInputElement&&requestAnimationFrame((()=>{this.submit()}))},this.onKeyup=t=>{const{key:e}=t;"Enter"!==e&&" "!==e||this.submit(),this.pressing=!1},this.onKeydown=()=>{this.pressing=!0},this.onSlotChange=()=>{this.wrapSlots(),this.autofocusit&&this.focusFirstApplicableItem()},this.wrapSlots=()=>{this.$slotted.forEach((t=>{if(!(t instanceof Se))return;const e=document.createElement("div"),n=document.createElement("li");t.replaceWith(e),(0,me.XX)(me.qy`
    ...
    `}};function Be(t){(0,o.append_styles)(t,"svelte-1ooljvd",".mondrian__suspense-3tgPBN.mondrian__--loading-3irTkJ{visibility:hidden}")}Ie=new WeakMap,Re.styles=Me,(0,ue.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],Re.prototype,"name",void 0),(0,ue.Cg)([(0,Ae.MZ)({type:Boolean,reflect:!0})],Re.prototype,"bordered",void 0),(0,ue.Cg)([(0,Ae.MZ)({type:Boolean,reflect:!0})],Re.prototype,"floating",void 0),(0,ue.Cg)([(0,Ae.MZ)({type:Boolean,reflect:!0})],Re.prototype,"autofocusit",void 0),Re=(0,ue.Cg)([(0,Ae.EM)("mon-menu")],Re),n(2466),o.SvelteComponent,n(9777),o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,n(2732),o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent;const Le=t=>({isLoading:1&t}),qe=t=>({isLoading:t[0]});function Ne(t){let e,n;const i=t[2].default,s=(0,o.create_slot)(i,t,t[1],qe);return{c(){e=(0,o.element)("div"),s&&s.c(),(0,o.attr)(e,"class","mondrian__suspense-3tgPBN"),(0,o.toggle_class)(e,"mondrian__--loading-3irTkJ",t[0])},m(t,i){(0,o.insert)(t,e,i),s&&s.m(e,null),n=!0},p(t,[r]){s&&s.p&&(!n||3&r)&&(0,o.update_slot_base)(s,i,t,t[1],n?(0,o.get_slot_changes)(i,t[1],r,Le):(0,o.get_all_dirty_from_scope)(t[1]),qe),(!n||1&r)&&(0,o.toggle_class)(e,"mondrian__--loading-3irTkJ",t[0])},i(t){n||((0,o.transition_in)(s,t),n=!0)},o(t){(0,o.transition_out)(s,t),n=!1},d(t){t&&(0,o.detach)(e),s&&s.d(t)}}}function je(t,e,n){let{$$slots:o={},$$scope:i}=e;const s=function(){const t=new Set;return(0,d.setContext)(ve,t),t}();let r=!0;return(0,d.onMount)((()=>{Promise.all(s).then((()=>{n(0,r=!1)}))})),t.$$set=t=>{"$$scope"in t&&n(1,i=t.$$scope)},[r,i,o]}class Fe extends o.SvelteComponent{constructor(t){super(),(0,o.init)(this,t,je,Ne,o.safe_not_equal,{},Be)}}const Te=Fe,Ze={[I](t,e,n,o){const i="self"===t.targetId?n:o[t.targetId];!1===e.hovered?J.get(i.id)?.revert():J.get(i.id)?.set(t.targetState)},[M](t,e,n,o){const i="self"===t.targetId?n:o[t.targetId];!1===e.hovered?tt.get(i.id)?.set(!t.targetVisibility):tt.get(i.id)?.set(t.targetVisibility)}},De=(t,e)=>{const n=et("trigger",t,(t=>{const{itemId:n,triggerId:o,...i}=t.detail,s=e[n];if(!s)throw new Error(`Could not execute trigger ${o} on item ${n} because the item could not be found.`);const r=s?.triggers.find((t=>t.id===o));if(!r)throw new Error(`Could not execute trigger ${o} on item ${n} because the trigger could not be found.`);const a=Ze[r.action];if(!a)throw new Error(`Could not execute trigger ${o} on item ${n} because an appropriate handler for its '${r.action}' action could not be found.`);a(r,i,s,e)}));return{destroy(){n()}}};function Oe(t){(0,o.append_styles)(t,"svelte-cm9a2g",".mondrian__preview-NTLm89{display:flex;justify-content:center;position:relative;z-index:0}")}function Xe(t){let e,n;return e=new Te({props:{$$slots:{default:[He]},$$scope:{ctx:t}}}),{c(){(0,o.create_component)(e.$$.fragment)},m(t,i){(0,o.mount_component)(e,t,i),n=!0},p(t,n){const o={};128&n&&(o.$$scope={dirty:n,ctx:t}),e.$set(o)},i(t){n||((0,o.transition_in)(e.$$.fragment,t),n=!0)},o(t){(0,o.transition_out)(e.$$.fragment,t),n=!1},d(t){(0,o.destroy_component)(e,t)}}}function We(t){let e,n,i,s;return{c(){e=(0,o.element)("div"),n=(0,o.text)("Block "),i=(0,o.text)(t[0]),s=(0,o.text)(" could not be loaded")},m(t,r){(0,o.insert)(t,e,r),(0,o.append)(e,n),(0,o.append)(e,i),(0,o.append)(e,s)},p(t,e){1&e&&(0,o.set_data)(i,t[0])},i:o.noop,o:o.noop,d(t){t&&(0,o.detach)(e)}}}function He(t){let e,n,i,s,r,a;return n=new ce({props:{itemId:t[6].id,isRoot:!0}}),{c(){e=(0,o.element)("div"),(0,o.create_component)(n.$$.fragment),(0,o.attr)(e,"class","mondrian__preview-NTLm89")},m(l,d){(0,o.insert)(l,e,d),(0,o.mount_component)(n,e,null),s=!0,r||(a=(0,o.action_destroyer)(i=De.call(null,e,t[2])),r=!0)},p:o.noop,i(t){s||((0,o.transition_in)(n.$$.fragment,t),s=!0)},o(t){(0,o.transition_out)(n.$$.fragment,t),s=!1},d(t){t&&(0,o.detach)(e),(0,o.destroy_component)(n),r=!1,a()}}}function Ke(t){let e,n,i,s;const r=[We,Xe],a=[];function l(t,e){return 1===e?function(t){const e=t.slice(),n=e[2][e[3]];return e[6]=n,e}(t):t}return e=function(t,e){return void 0===t[1]||void 0===t[3]?0:1}(t),n=a[e]=r[e](l(t,e)),{c(){n.c(),i=(0,o.empty)()},m(t,n){a[e].m(t,n),(0,o.insert)(t,i,n),s=!0},p(t,[o]){n.p(l(t,e),o)},i(t){s||((0,o.transition_in)(n),s=!0)},o(t){(0,o.transition_out)(n),s=!1},d(t){t&&(0,o.detach)(i),a[e].d(t)}}}function Pe(t,e,n){let{manifest:o}=e,{blockumentId:i}=e;const s=Symbol("LearnComponent"),r=o.blockuments?.[i],a=o.items??{},l=r?.children[0]?.id;return Pt.addManifest(s,o),(0,d.setContext)("isLearn",!0),Object.values(a).forEach((t=>{J.add(t.id,(0,U.readable)(t.initialState)),tt.add(t.id,(0,U.readable)(t.initialVisible))})),(0,d.onMount)((()=>{J.resetAll(),tt.resetAll()})),(0,d.onDestroy)((()=>{Pt.removeManifest(s)})),t.$$set=t=>{"manifest"in t&&n(4,o=t.manifest),"blockumentId"in t&&n(0,i=t.blockumentId)},[i,r,a,l,o]}class Ge extends o.SvelteComponent{constructor(t){super(),(0,o.init)(this,t,Pe,Ke,o.safe_not_equal,{manifest:4,blockumentId:0},Oe)}}const Ye=Ge;var Ue=n(2834),Ve=n.n(Ue);const Je=((t,e={},n="div")=>o=>{const i=(0,Ue.useRef)(null),s=(0,Ue.useRef)(null),[r,a]=(0,Ue.useState)(!1);return(0,Ue.useEffect)((()=>{const e=/on([A-Z]{1,}[a-zA-Z]*)/,n=/watch([A-Z]{1,}[a-zA-Z]*)/;s.current=new t({target:i.current,props:o});const r=[];for(const t in o){const i=t.match(e),a=t.match(n);null!=i&&"function"==typeof o[t]&&s.current.$on(`${i[1][0].toLowerCase()}${i[1].slice(1)}`,o[t]),null!=a&&"function"==typeof o[t]&&r.push([`${a[1][0].toLowerCase()}${a[1].slice(1)}`,o[t]])}if(r.length>0){const t=s.current.$$.update;s.current.$$.update=function(){r.forEach((([t,e])=>{if(null!==s.current){const n=s.current.$$.props[t];e(s.current.$$.ctx[n])}})),t.apply(null)}}return()=>{null!==s.current&&s.current.$destroy()}}),[o]),(0,Ue.useEffect)((()=>{r?null!==s.current&&s.current.$set(o):a(!0)}),[o,r]),Ve().createElement(n,{ref:i,style:e})})(Ye),Qe=t=>Ve().createElement(Je,{...t})}}]);
//# sourceMappingURL=5e84176f.js.map